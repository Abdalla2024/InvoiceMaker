  ...
  const features = [
    {
      ...
      description: "Create stunning, business-ready invoices with our beautifully designed templates. Add your company branding and client details with ease."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Generate high-quality PDF invoices instantly with perfect formatting. Professional layout ensures your invoices look great on any device."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 7C19 7 20 8 20 11.5C20 15 19 16 19 16" stroke="currentColor" strokeWidth="2"/>
          <path d="M5 7C5 7 4 8 4 11.5C4 15 5 16 5 16" stroke="currentColor" strokeWidth="2"/>
          <path d="M9 9H15" stroke="currentColor" strokeWidth="2"/>
          <path d="M9 13H15" stroke="currentColor" strokeWidth="2"/>
          <path d="M9 5V19L12 17L15 19V5H9Z" stroke="currentColor" strokeWidth="2"/>
        </svg>
      ),
      title: "Smart Calculations",
      description: "Automatic calculation of subtotals, taxes, and totals. Add multiple line items with quantities and rates for accurate billing."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Personalize your invoices with custom company information, logos, and payment terms. Save templates for quick invoice creation."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: "Easy Sharing",
      description: "Share invoices instantly via email, messages, or AirDrop. Export PDFs to your preferred cloud storage service for backup and organization."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Store client information securely for quick access when creating new invoices. Build your client database and streamline your billing process."
    }
  ]
    ...
    <section id="features" className="features">
      <div className="container">
        <div className="section-header">
          <h2>Powerful Features for Professional Invoicing</h2>
          <p>
